...
* The original package name is 'com.Contact.Book'.
* This Project was setup using the maven build tool.

#### Install dependencies, Create your personal environment configuration if necessary

```
 For example- database config to application.properties file

spring.datasource.url=jdbc:mysql://localhost:3306/contact_book_db
spring.datasource.username=root
spring.datasource.password=root
```

* The project Details Functionalities -
  ``` 
